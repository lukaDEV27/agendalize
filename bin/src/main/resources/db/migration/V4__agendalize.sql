...
INSERT INTO `flyway_schema_history` VALUES (1,'1','<< Flyway Baseline >>','BASELINE','<< Flyway Baseline >>',NULL,'root','2024-04-16 20:09:41',0,1),(2,'2','agendalize','SQL','V2__agendalize.sql',-717402143,'root','2024-04-20 22:16:19',3555,1),(3,'3','agendalize','SQL','V3__agendalize.sql',1021812080,'root','2024-05-14 17:02:58',2977,1);
...
INSERT INTO `permissao` VALUES (3,'admin');
...
CREATE TABLE `telefone` (
  ...
  `empresa_id` varchar(11) NOT NULL,
  PRIMARY KEY (`id_telefone`),
  KEY `empresa_id_idx` (`empresa_id`),
  CONSTRAINT `empresa_id` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`cnpj_empresa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'admin@admin.com','$2a$10$Q0lQAqnjcKus7LpxI.MoUO5ek6kiF1oTdRAtAJPSQgWRPd8pdzZvG');
...
-- Dump completed on 2024-05-15 18:07:39
